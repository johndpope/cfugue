...
#define QHTM_H
	...
	typedef CQHTMImageABC * (*funcQHTMImageCallback)( LPCTSTR pcszImageURL );
...
extern "C" {
	...
	typedef HBITMAP (*funcQHTMBitmapCallback)( LPCTSTR pcszImageURL );
	typedef HGLOBAL (*funcQHTMResourceCallback)( LPCTSTR pcszResourceName );
	typedef void (*funcQHTMFORMCallback)( HWND hwndQHTM, LPQHTMFORMSubmit pFormSubmit );
